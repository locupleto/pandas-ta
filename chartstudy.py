...
#
# Package : -
# Module  : studysuite.py
#
# Description: test cases for the marketdata package            
#
...
try:
    ...
    # Use the AV module as needed in your code
except ImportError as e:
    # Handle the absence of alphaVantageAPI
    AV = None  # or any other fallback logic
    # You can also pass here if you don't want to print anything, just handle it silently
    pass
